...
public class zadanie3 {
    public static void main(String[] args) {
        ...
        //dopiero w tym zadaniu pojąłem polimorfizm, więc proszę wybaczyć jego brak w poprzednich zadaniach.

        Wektor info = new Wektor();
        WektorZaczepiony zaczepiony = new WektorZaczepiony();


        WektorZaczepiony wektor1 = new WektorZaczepiony();
        Wektor wektor2 = new Wektor();
        Wektor wektor3 = new Wektor();
        WektorZaczepiony wektor4 = new WektorZaczepiony();
        Wektor wektor5 = new Wektor();
        WektorZaczepiony wektor6 = new WektorZaczepiony();
        Wektor wektor7 = new Wektor();
        Wektor wektor8 = new Wektor();
        WektorZaczepiony wektor9 = new WektorZaczepiony();
        Wektor wektor10 = new Wektor();
        Wektor wektor11 = new Wektor();
        Wektor wektor12 = new Wektor();
        WektorZaczepiony wektor13 = new WektorZaczepiony();
        Wektor wektor14 = new Wektor();
        Wektor wektor15 = new Wektor();

        wektor1.addVector("a", 0, 1,5,6);
        wektor2.addVector("b", 2.4, 10);
        wektor3.addVector("c", 5.3, 12);
        wektor4.addVector("d", 2, 1.2,53,2);
        wektor5.addVector("e", 2, 4);
        wektor6.addVector("f", 1, 3,5,2);
        wektor7.addVector("g", 0, 0);
        wektor8.addVector("h", 34, 2.5);
        wektor9.addVector("i", 7.4, 5.3,4,1);
        wektor10.addVector("j", 5.8, 42);
        wektor11.addVector("k", 43.23, 0);
        wektor12.addVector("l", 0, 7.10);
        wektor13.addVector("m", 1.51, 5.54,5,68);
        ...
        System.out.println("7. Zmiana punktu zaczepienia wektora.");
        ...
        switch (sc.nextInt())
        {
            ...
            case 7:
            {
                System.out.println("Podaj nazwę wektoru, którego punkt zaczepienia chcesz zmienić");
                String vectorName = sc.next();
                System.out.println("Podaj nową współrzędną xz:");
                Double xz = sc.nextDouble();
                System.out.println("Podaj nową współrzędną yz:");
                Double yz = sc.nextDouble();
                zaczepiony.changeAnchorPoint(vectorName,xz,yz,tablica);
                break;
            }
